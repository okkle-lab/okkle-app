...
export default function LogScreen() {
  ...
  function handleSave() {
    ...
    if (tab === 'mileage') {
      ...
      saveRecord({ record_type: 'mileage', platform, miles: parseFloat(miles), deduction, amount: null, category: null, period_start: ps, period_end: pe, receipt_uri: receiptUri, notes: null }, createdAt);
    } else if (tab === 'income') {
