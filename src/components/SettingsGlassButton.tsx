...
export function SettingsGlassButton({ onPress, style, size = 40, hitSlop = 12 }: Props) {
...
const s = StyleSheet.create({
  outer: {
    ...
    boxShadow: '0 8px 18px rgba(21,33,29,0.08), 0 2px 6px rgba(21,33,29,0.06)',
  },
  outerDark: {
    boxShadow: '0 10px 18px rgba(0,0,0,0.20), 0 2px 6px rgba(0,0,0,0.18)',
  },
